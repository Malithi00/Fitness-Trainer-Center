...
<body>
    ...
    <div class="form">
		<form method="POST" action="submitFAQ.php">
			...
			<br/>
			<input type="text" name="Question" placeholder="Question" class="textbox" required><br/><br/>
	
			<br/>
			<input type="text" name="Answer" placeholder="Answer" class="textbox" required><br/><br/><br/>
			
			<br/><br/>
	

			<center>
				<input type="submit" name="submitBtn" id="submitBtn" class="register" value="Add FAQ"><br/><br/><br/>
		    </center>
    ...
    <br/><br/>
    <center><button class="dis"><a href="displayFAQ.php">Update FAQ</a></button></center>
