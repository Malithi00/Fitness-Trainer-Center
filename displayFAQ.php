...
<head>
	...
	<link rel="stylesheet" href="css/displayFAQ.css">
...
<body>
    ...
    <br/><br/>
    <center><h1 class="topic">Frequently Asked Questions</h1></center>
    <br/><br/>
    ...
    if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
            ...
            echo "<tr>";
				...
				echo "<td><button type='submit'><a href='editFAQ.php?id=$id'>Edit</a></button></td>";
				echo "<td><button type='submit'><a href='deleteFAQ.php?id=$id'>Delete<a/></button></td>";
            echo "</tr>";
          }
   ...
   <br/><br/><br/><button class="dis"><a href="addFAQ.php">Add FAQ</a></button>
