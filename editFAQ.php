...
?>
    ...
    <div class="form">
		<form method="POST" action="updateFAQ.php?id=<?php echo $id; ?>">

			<center><div class="Register-title">Edit FAQs</div><br/><br/></center>

            <br/>FAQ ID:
			<input type="text" name="id"  class="textbox" value="<?php echo $code ?>" required><br/><br/>

			<br/>Question:
			<input type="text" name="Question"  class="textbox" value="<?php echo $ques ?>" required><br/><br/>
	
			<br/>Answer:
			<input type="text" name="Answer"  class="textbox" value="<?php echo $ans ?>" required><br/><br/><br/>
	
			<center>
				<input type="submit" name="submitBtn" id="submitBtn" class="register" value="Update FAQ"><br/><br/><br/>
		    </center>
